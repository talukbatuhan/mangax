...
export default function AdminSidebar() {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Türler / Kategoriler", href: "/admin/genres", icon: Tag }, // İkonu Tag yaptık
  ...
  return (
    // Scrollbar gizleme sınıfları ekli
    <div className="w-64 bg-black border-r border-white/10 h-screen fixed left-0 top-0 overflow-y-auto flex flex-col scrollbar-hide [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']">
