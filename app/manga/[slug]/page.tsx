    ...
    <div className="min-h-screen bg-gray-950 text-white font-sans">
               ...
               {manga.genres && (
                 <div className="flex gap-2 mt-3">
                   {manga.genres.map((g: string) => (
                     <span key={g} className="text-xs bg-white/10 px-2 py-1 rounded text-gray-300 border border-white/5">
                       {g}
                     </span>
                   ))}
                 </div>
      ...
      <div className="container mx-auto px-6 py-10 grid md:grid-cols-3 gap-10">
        <div className="md:col-span-2">
          <h2 className="text-2xl font-bold mb-4 text-green-400 border-l-4 border-green-500 pl-3">Özet</h2>
          <p className="text-gray-300 leading-relaxed mb-10 text-lg">
            {manga.description || "Açıklama girilmemiş."}
          </p>

          <h2 className="text-2xl font-bold mb-4 text-green-400 border-l-4 border-green-500 pl-3">Bölümler</h2>
            ...
            {chapters?.map((chapter) => (
              ...
              >
                <div className="flex items-center gap-3">
                    ...
                    {chapter.title && <span className="text-gray-500 text-sm hidden sm:inline">- {chapter.title}</span>}
                </div>
